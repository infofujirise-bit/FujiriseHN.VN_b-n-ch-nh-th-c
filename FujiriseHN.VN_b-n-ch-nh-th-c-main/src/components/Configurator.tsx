        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 right-8">
                    <p className="text-fuji-accent text-xs font-bold uppercase tracking-wider mb-2"></p>
          ...
          <div className="w-full lg:w-[450px]">
              ...
              {configs.map((config) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                        <h4 className={`font-bold text-sm uppercase tracking-wider ${active.id === config.id ? 'text-fuji-accent' : 'text-white'}`}>
                            {config.name}
                        </h4>
            ...
            <button 
              ...
              className="mt-8 w-full py-4 bg-white text-fuji-blue rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-fuji-accent hover:text-white transition-all flex items-center justify-center gap-3"
            >
              ...
              {!isSuccess ? (
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <button
                    ...
                    className={`w-full py-4 rounded-2xl flex items-center justify-center gap-3 font-bold text-xs uppercase tracking-wider transition-all mt-6 ${isSubmitting ? "bg-slate-100 text-slate-400" : "bg-fuji-blue text-white hover:bg-fuji-accent shadow-xl shadow-fuji-blue/20"}`}
                  >
