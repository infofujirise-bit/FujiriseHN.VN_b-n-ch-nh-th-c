...
import { CONTACT_INFO, getCachedSettings } from '../constants';
          ...
          <div>
            ...
            <div className="space-y-10">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <h4 className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1">Hotline  </h4>
                  <p className="text-fuji-blue font-bold text-2xl tracking-tight">{formatHotline(companyInfo.hotline)}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <h4 className="text-[10px] font-bold uppercase tracking-wider text-slate-400 mb-1">Văn phòng</h4>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 relative z-10">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label className="text-[10px] font-bold uppercase tracking-wider text-white/50 block ml-1">Họ và tên *</label>
                    <input
                  ...
                  <div className="space-y-3">
                    <label className="text-[10px] font-bold uppercase tracking-wider text-white/50 block ml-1">Số điện thoại *</label>
                    <input
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-white/50 block ml-1">Yêu cầu của bạn</label>
                  <textarea
                    {...register("message")}
                    rows={4}
                ...
                <button
                  ...
                  className={cn(
                "w-full py-5 rounded-2xl flex items-center justify-center gap-3 font-bold text-xs uppercase tracking-wider transition-all duration-300",
            ...
            {isSuccess && (
              ...
              >
                ...
                <p className="text-white/70 font-medium text-lg leading-relaxed max-w-sm">
                  ...
                  Đội ngũ chuyên viên sẽ liên hệ lại.
                </p>
              </motion.div>
            )}
          </div>
