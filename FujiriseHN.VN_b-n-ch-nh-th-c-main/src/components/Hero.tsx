...
export default function Hero() {
    ...
    return (
      <>
        <span className="block">{line1}</span>
          <span className="block text-transparent bg-clip-text bg-gradient-to-r from-fuji-accent to-yellow-400 drop-shadow-[0_0_25px_rgba(197,160,89,0.6)] py-1 pr-4">{highlight}</span>
  ...
  return (
    <section id="home" className="relative h-screen min-h-[700px] flex items-center justify-center bg-slate-900 overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 w-full text-center mt-24 md:mt-32">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-4 mb-8">
            <div className="w-12 h-[1px] bg-fuji-accent" />
            <span className="text-fuji-accent text-[10px] md:text-sm uppercase font-bold tracking-wider">
              FUJIRISE - THANG MÁY CHO MỌI GIA ĐÌNH
            </span>
            <div className="w-12 h-[1px] bg-fuji-accent" />
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link to="/contact" className="px-12 py-5 bg-fuji-accent text-white font-bold text-xs uppercase tracking-wider hover:bg-white hover:text-fuji-dark transition-all rounded-[20px] shadow-2xl shadow-fuji-accent/20">
              YÊU CẦU TƯ VẤN THIẾT KẾ
            </Link>
            <Link to="/products" className="px-12 py-5 bg-white/5 backdrop-blur-md border border-white/20 text-white font-bold text-xs uppercase tracking-wider hover:bg-white/10 transition-all rounded-[20px]">
              BỘ SƯU TẬP 2026
            </Link>
          </div>
        </div>
